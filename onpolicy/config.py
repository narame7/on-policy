...
def get_config():
    ...
    # prepare parameters
    parser.add_argument(
        "--algorithm_name", type=str, default="rmappo", choices=["rmappo", "mappo", "happo", "hatrpo", "mat", "mat_dec"]
    )
    ...
    parser.add_argument(
        "--num_env_steps", type=int, default=10e6, help="Number of environment steps to train (default: 10e6)"
    )
    parser.add_argument(
        "--user_name",
        type=str,
    ...
    # env parameters
    parser.add_argument("--env_name", type=str, default="Checkers-v0", help="specify the name of environment")
    parser.add_argument(
        "--use_obs_instead_of_state",
        action="store_true",
        default=False,
    ...
    # save parameters
    parser.add_argument(
        "--save_interval", type=int, default=1, help="time duration between contiunous twice models saving."
    )

    # log parameters
    parser.add_argument(
        "--log_interval", type=int, default=5, help="time duration between contiunous twice log printing."
    )
    ...
    parser.add_argument(
        "--eval_interval", type=int, default=25, help="time duration between contiunous twice evaluation progress."
    )
